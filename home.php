...
<div class="home">
   ...
   <section class="center">
      ...
      <form action="search.php" method="post">
         ...
         <div class="flex">
            <div class="box">
               ...
               <select name="h_type" class="input" required>
                  <option value="house">Boardinghouse</option>
               </select>
            </div>
            <div class="box">
         ...
         <input type="submit" value="search boarding house" name="h_search" class="btn">
      </form>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         ...
         <div class="box">
            ...
            <div class="flex">
               <p><i class="fas fa-house"></i><span>Boarding House</span></p>
