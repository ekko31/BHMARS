...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-peso-sign"></i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <div class="flex">
         ...
         <div class="box">
            <p><i>vacancies :</i><span><?= $fetch_property['availability']; ?></span></p>
         </div>
      </div>
      ...
      <div class="flex">
         <div class="box">
            ...
            <p><i class="fas fa-<?php if($fetch_property['water_supply'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>water supply charges</span></p>
