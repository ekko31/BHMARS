...
if(isset($_POST['update'])){
   ...
   $update_listing = $conn->prepare("UPDATE `property` SET property_name = ?, address = ?, price = ?, type = ?, offer = ?, status = ?, rooms = ?, deposite = ?, bedroom = ?, bathroom = ?, availability = ?, wifi_connection = ?, water_supply = ?, electricity = ?, parking_area = ?, school_area = ?, description = ? WHERE id = ?");   
   $update_listing->execute([$property_name, $address, $price, $type, $offer, $status, $rooms, $deposite, $bedroom, $bathroom,  $availability, $wifi_connection, $water_supply, $electricity, $parking_area, $school_area, $description, $update_id]);
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="enter boarding house name" value="<?= $fetch_property['property_name']; ?>" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>boarding house price <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" value="<?= $fetch_property['price']; ?>" placeholder="enter boarding house price" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <input type="text" name="address" required maxlength="100" placeholder="enter boarding house full address" class="input" value="<?= $fetch_property['address']; ?>">
         </div>
         <div class="box">
      ...
      <div class="checkbox">
         <div class="box">
            <p><input type="checkbox" name="wifi_connection" value="yes" <?php if($fetch_property['wifi_connection'] == 'yes'){echo 'checked'; } ?> />free wifi</p>
            <p><input type="checkbox" name="water_supply" value="yes" <?php if($fetch_property['water_supply'] == 'yes'){echo 'checked'; } ?> />water supply charges</p>
            <p><input type="checkbox" name="electricity" value="yes" <?php if($fetch_property['electricity'] == 'yes'){echo 'checked'; } ?> />electricity charges</p>
         </div>
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" <?php if($fetch_property['parking_area'] == 'yes'){echo 'checked'; } ?> />parking area</p>
            <p><input type="checkbox" name="school_area" value="yes" <?php if($fetch_property['school_area'] == 'yes'){echo 'checked'; } ?> />school area</p>
         </div>
      </div>
      <div class="box">
