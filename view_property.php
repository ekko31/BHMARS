...
<section class="view-property">
   ...
   <h1 class="heading">boarding house details</h1>
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-peso-sign"></i><span><?= $fetch_property['price']; ?> per room</span></p>
         <p><i class="fas fa-user"></i><span><?= $fetch_user['name']; ?></span></p>
         <p><i class="fas fa-phone"></i><a href="tel:12345678901"><?= $fetch_user['number']; ?></a></p>
      ...
      <div class="flex">
         <div class="box">
            <p><i>rooms :</i><span><?= $fetch_property['rooms']; ?> rooms</span></p>
            <p><i>deposit amount : </i><span><span class="fa-solid fa-peso-sign" style="margin-right: .5rem;"></span><?= $fetch_property['deposite']; ?></span></p>
         ...
         <div class="box">
            <p><i>vacancies :</i><span><?= $fetch_property['availability']; ?> room vacant</span></p>
         </div>
      </div>
      <h3 class="title">amenities</h3>
      <div class="flex">
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['wifi_connection'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>free wifi</span></p>
            <p><i class="fas fa-<?php if($fetch_property['water_supply'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>water supply</span></p>
            <p><i class="fas fa-<?php if($fetch_property['electricity'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>electricity charges</span></p>
         </div>
         <div class="box">
            <p><i class="fas fa-<?php if($fetch_property['parking_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>parking area</span></p>
            <p><i class="fas fa-<?php if($fetch_property['school_area'] == 'yes'){echo 'check';}else{echo 'times';} ?>"></i><span>school area</span></p>
         </div>
      </div>
      ...
      <?php
            ...
            <p class="description"><?= $fetch_renters['name']; ?> rates: <i class="fa fa-star"></i><span><?= $fetch_ratings['ratings']; ?> stars</span></p>
